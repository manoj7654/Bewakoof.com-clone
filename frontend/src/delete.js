...
async function getData() {
    try {
      let res = await fetch("https://ill-blue-gosling-coat.cyclic.app/adminproduct/allproducts");
  ...
  async function deletedata(ID){
    console.log(ID)
    try {
        let response=await fetch(`https://ill-blue-gosling-coat.cyclic.app/adminproduct/delete/${ID}`,{
